...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".my-input {\n    background-color: transparent;\n    color: darkviolet;\n    border: none;\n    outline: none;\n}\n\n.my-input[type = 'text'],\n.my-input[type = 'number'],\n.my-input[type = 'email'] {\n    padding: 10px 20px;\n    border: 1px solid #777c85;\n}\n", "",{"version":3,"sources":["webpack://./src/Input/Input.css"],"names":[],"mappings":"AAAA;IACI,6BAA6B;IAC7B,iBAAiB;IACjB,YAAY;IACZ,aAAa;AACjB;;AAEA;;;IAGI,kBAAkB;IAClB,yBAAyB;AAC7B","sourcesContent":[".my-input {\n    background-color: transparent;\n    color: darkviolet;\n    border: none;\n    outline: none;\n}\n\n.my-input[type = 'text'],\n.my-input[type = 'number'],\n.my-input[type = 'email'] {\n    padding: 10px 20px;\n    border: 1px solid #777c85;\n}\n"],"sourceRoot":""}]);
// Exports
...
//# sourceMappingURL=main.5b7cab7ea22fbd3c3950.hot-update.js.map