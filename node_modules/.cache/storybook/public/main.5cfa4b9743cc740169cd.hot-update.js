...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".my-input {\n    background-color: transparent;\n    color: darkviolet;\n    border: none;\n    outline: none;\n}\n\n.my-input[type = 'text'],\n.my-input[type = 'number'],\n.my-input[type = 'email'] {\n    padding: 20px;\n}\n", "",{"version":3,"sources":["webpack://./src/Input/Input.css"],"names":[],"mappings":"AAAA;IACI,6BAA6B;IAC7B,iBAAiB;IACjB,YAAY;IACZ,aAAa;AACjB;;AAEA;;;IAGI,aAAa;AACjB","sourcesContent":[".my-input {\n    background-color: transparent;\n    color: darkviolet;\n    border: none;\n    outline: none;\n}\n\n.my-input[type = 'text'],\n.my-input[type = 'number'],\n.my-input[type = 'email'] {\n    padding: 20px;\n}\n"],"sourceRoot":""}]);
// Exports
...
//# sourceMappingURL=main.5cfa4b9743cc740169cd.hot-update.js.map