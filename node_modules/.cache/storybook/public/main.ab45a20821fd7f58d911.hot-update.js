...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".my-button {\n    padding: 10px 15px;\n    color: darkviolet;\n    background-color: transparent;\n    border: 1px solid darkviolet;\n}\n\n.big {\n    font-size: 20px;\n    padding: 20px 25px;\n}\n\n.primary {\n    background-color:\n}\n", "",{"version":3,"sources":["webpack://./src/MyButton/MyButton.css"],"names":[],"mappings":"AAAA;IACI,kBAAkB;IAClB,iBAAiB;IACjB,6BAA6B;IAC7B,4BAA4B;AAChC;;AAEA;IACI,eAAe;IACf,kBAAkB;AACtB;;AAEA;IACI;AACJ","sourcesContent":[".my-button {\n    padding: 10px 15px;\n    color: darkviolet;\n    background-color: transparent;\n    border: 1px solid darkviolet;\n}\n\n.big {\n    font-size: 20px;\n    padding: 20px 25px;\n}\n\n.primary {\n    background-color:\n}\n"],"sourceRoot":""}]);
// Exports
...
//# sourceMappingURL=main.ab45a20821fd7f58d911.hot-update.js.map